...
|---|---|---|---|
| `hello` | móvil→PC | `{"m":"hello","pv":1,"token":"...","code":"1234"?,"name":"<móvil>","model":"<modelo>","role":"wiimote"\|"nunchuk"?,"pad":"wiimote"\|"retropad"\|"nes"\|"gun"?,"nunchuk":"own"?,"screen_only":true?}` | `ok` / `err` |
