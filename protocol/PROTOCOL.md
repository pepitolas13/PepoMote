...
|---|---|---|---|
| `hello` | móvil→PC | `{"m":"hello","pv":1,"token":"...","code":"1234"?,"name":"<móvil>","model":"<modelo>","role":"wiimote"\|"nunchuk"?,"pad":"wiimote"?,"nunchuk":"own"?}` | `ok` / `err` |
| `ok` | PC→móvil | `{"m":"ok","session_id":u32,"udp_port":26761,"token":"..."?,"mode":"pointer","slot":0,"role":"wiimote","player":1,"name":"<PC>","modes":["pointer","dolphin","cemu"],"pad":"gamepad"\|"pro"\|"wiimote"\|"nunchuk","nunchuk":"own"\|"none"}` | — |
