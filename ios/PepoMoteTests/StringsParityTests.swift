...
final class StringsParityTests: XCTestCase {
    ...
    func testClavesUsadasPorElCodigo() throws {
        ...
        for key in ["exit", "keyboard", "precision", "in_cemu", "gamepad", "pro_controller", "wii_remote", "activating_wiiu",
                    ...
                    "update_notes_version", "update_check_now", "update_checking", "update_current", "update_ready",
                    "update_failed", "update_changed", "update_cached", "update_ios_handoff", "update_open_store",
                    "update_store_opened", "update_store_missing", "update_copy_source", "update_source_copied",
                    "update_store_steps", "update_install_guide",
                    "update_open_altstore_legacy", "update_altstore_legacy_help",
