...
# xz y no el zstd por defecto del runner: dpkg solo lee zstd desde Debian bookworm /
# Ubuntu 21.10 (PureOS byzantium del Librem 5 y Debian bullseye no lo abren)
