...
object ReceiverCapabilities {
    ...
    fun modes(platform: String, supportsCemu: Boolean, supportsSwitch: Boolean, supportsRetroArch: Boolean = false): List<String> = buildList {
    ...
    fun select(requested: String?, current: String, platform: String, supportsCemu: Boolean, supportsSwitch: Boolean, supportsRetroArch: Boolean = false): String {
        val available = modes(platform, supportsCemu, supportsSwitch, supportsRetroArch)
