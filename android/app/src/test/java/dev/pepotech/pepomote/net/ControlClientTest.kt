        ...
        ServerSocket(0).use { listener ->
            ...
            try {
                listener.accept().use { socket ->
                    ...
                    send("""{"m":"ok","session_id":1,"mode":"switch","modes":["pointer","cemu","switch"],"pad":"joycons","half":"left","side":null,"player":1,"tilt":true,"frame_rotation":true}""")
                    ...
                    assertTrue(confirmed.supportsFrameRotation)
                    ...
                    assertFalse(legacy.supportsFrameRotation)
