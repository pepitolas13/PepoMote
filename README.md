...
**PepoMote 1.11.0: updates and release notes inside the app.** Discover new versions, see what's changed and continue installation with download progress and package verification. Install this version once to get the new updater. Includes the existing integrated keyboard and RetroArch Wii Remote pointer. [What is new in 1.11.0](docs/releases/v1.11.0.md) · [How to update](docs/UPDATES.md) · [Published downloads](https://github.com/pepitolas13/PepoMote/releases).
...
- **Updates and release notes**: automatic detection, brief in-app notes and a verified download when you choose Install. Android requires system confirmation; iPhone/iPad continues in SideStore or AltStore. Automatic notices can be disabled in Settings. [How it works and the first rollout](docs/UPDATES.md). Controls travel directly between your devices over your local network or configured VPN; PepoMote does not run its own relay service.
