...
- **Wii Remote + Nunchuk side** (1.6): the first time the sideways Wii Remote + Nunchuk appears, the app asks whether it is the right way up ("Flip it" / "Keep it like this") and the side stays fixed for good (some phones' sensors flipped it on their own); changeable in Settings
